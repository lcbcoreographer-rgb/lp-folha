...
const INDICADORES = [
  ...
  { contagem: { para: 10, prefixo: "+" }, texto: "segmentos atendidos, de portos a agronegócio" },
  { contagem: { para: 60, prefixo: "+" }, texto: "clientes atendidos" },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <dl className="grid grid-cols-2 gap-x-8 gap-y-12 lg:grid-cols-4">
          {INDICADORES.map((item, i) => (
            <ScrollReveal key={item.texto} direction="up" delay={i * 90}>
